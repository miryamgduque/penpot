...
6. [Phase 06 — Parallel phrasing A/B + measurement](./doing-phase-06-parallel-ab-measurement.md) — stronger batching language + calls/round measurement recipe (learning 9a)
